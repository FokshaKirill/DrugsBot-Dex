...
public static class ValidationMessages
{
    ...
    public static string WrongPrecisionScale =
        "{PropertyName} должен содержать {} цифр до запятой и {} - после, игнорируя конечные нули";

    public static string WrongCountryCode =
        "{PropertyName} имеет некорректный код страны. Он должен состоять из двух больших латинских букв";
    ...
    public static string InclusiveBetweenError =
        "{PropertyName} должен находится в диапазоне чисел от {min} до {max} включительно";
}